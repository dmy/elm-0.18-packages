...
{
	if (region.T.z === region.aa.z)
	{
		return 'on line ' + region.T.z;
	}
	return 'on lines ' + region.T.z + ' through ' + region.aa.z;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.P, request.aQ, true);
		}
		catch (e)
		{
...
function _Http_toResponse(xhr)
{
	return {
		aQ: xhr.responseURL,
		aM: { aB: xhr.status, k: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aF: 'hidden', y: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aF: 'mozHidden', y: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aF: 'msHidden', y: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aF: 'webkitHidden', y: 'webkitvisibilitychange' }
		: { aF: 'hidden', y: 'visibilitychange' };
}
...
var author$project$Main$Model = F3(
	function (packages, error, search) {
		return {M: error, R: packages, J: search};
	});
...
var author$project$Main$Package = F3(
	function (name, summary, versions) {
		return {A: name, as: summary, W: versions};
	});
...
var author$project$Main$getPackages = A2(
	...
	A2(elm$http$Http$get, 'https://cors-anywhere.herokuapp.com/http://package.elm-lang.org/all-packages?elm-package-version=0.18', author$project$Main$packagesDecoder));
...
var author$project$Main$url = function (pkg) {
	return elm$core$String$concat(
		_List_fromArray(
			[
				...
				'/',
				function () {
				var _n0 = elm$core$List$head(pkg.W);
				if (!_n0.$) {
					var version = _n0.a;
					return version;
				} else {
...
var author$project$Main$package = function (pkg) {
	var _n0 = function () {
		var _n1 = A2(elm$core$String$split, '/', pkg.A);
			...
			[
				...
				_List_fromArray(
					[
						...
						function () {
						var _n3 = elm$core$List$head(pkg.W);
						if (!_n3.$) {
							var version = _n3.a;
							return A2(
								elm$html$Html$span,
...
var author$project$Main$catalog = function (model) {
	var search = elm$core$String$isEmpty(model.J) ? 'elm-lang/' : model.J;
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(
			...
			A2(
				...
				function (p) {
					return A2(elm$core$String$contains, search, p.A);
				},
				model.R)));
};
var author$project$Main$footer = A2(
	...
	_List_fromArray(
		[
			...
			elm$html$Html$text(' and written in Elm. Thank you to '),
			A2(
			elm$html$Html$a,
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				if (!_n0.$) {
					var error = _n0.a;
					return elm$html$Html$text('Service unavailable.');
				} else {
					return A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_Nil),
								author$project$Main$catalog(model)
							]));
				}
			}(),
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('https://web.archive.org/web/20180714175916/https://guide.elm-lang.org/')
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Elm 0.18 Guide')
											]))
									])),
								A2(
								elm$html$Html$li,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Fancy Search')
											]))
									]))
							]))
					])),
